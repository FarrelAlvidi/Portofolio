  ...
  return (
    <div className="py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto text-center">
        <h1 className="text-black font-mono text-3xl sm:text-4xl">
          Contact Me
        </h1>
      ...
      {/* Form Card */}
      <form action="https://formsubmit.co/farrelalvidi.itxpro@gmail.com" method="POST">
        <div className="bg-white  shadow-lg p-8 sm:p-12 mt-10 max-w-2xl w-full mx-auto">
          <div className="space-y-8">
            ...
            <div className="flex pt-4">
              <button type="submit" className=" text-gray-700 rounded-lg font-mono">
                Send message
